   ...
   // DatabaseReference mref;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            progresstxt.add(ischeckedcount.get(i) + " из " + totalitemcount.get(i));
        ...
        public boolean onActionItemClicked(final ActionMode mode, MenuItem item) {
            ...
            switch (item.getItemId()) {
                ...
                case R.id.edit:
                    ...
                    builder.setTitle("Введите новое название списка");
                    ...
                    builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            boolean bc = newitem.matches(".*[a-zA-Zа-яА-Я].*");
                            if (bc == false && !myDb.titleExists(newitem)) {
                                Snackbar snackbar = Snackbar.make(findViewById(android.R.id.content), "Введите название", Snackbar.LENGTH_LONG);
                                snackbar.show();
                            }
                            else if (bc == true && myDb.titleExists(newitem)) {
                                Snackbar snackbar = Snackbar.make(findViewById(android.R.id.content), "Уже включено!", Snackbar.LENGTH_LONG);
                                snackbar.show();
                            }
                            else {

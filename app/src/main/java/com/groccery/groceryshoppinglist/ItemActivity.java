...
import static com.groccery.groceryshoppinglist.CustomAdapter3.mc_currentcurrency;
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (k == 0) {
                    ...
                    textView.setText("Всего: " + s + " " + mc_currentcurrency);
        ...
        public boolean onActionItemClicked(final ActionMode mode, MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.mcprice: {
                    ...
                    builder.setTitle("Введите цену за ед. товара");
                    ...
                    builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if (bc == false && !myDb.itemExists(maintitle, newitem) && !newitem.equals("")) {
                                ...
                                builder.setMessage("Выберите величину:");
                                builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
